    ...
    <div class="login-wrapper">
        ...
        <div class="login-left">
            ...
            <div class="brand-content">
                <img src="{{ url('logo.png') }}" alt="JNE Logo" style="width: 200px; height: 200px; object-fit: contain; margin-bottom: 2rem;">
        ...
        <div class="login-right">
            <div class="login-card">
                ...
                <!-- Info: Order Request pindah ke APPSHub -->
                <div style="background: linear-gradient(135deg, #eff6ff, #eef2ff); border: 1px solid #bfdbfe; border-radius: 12px; padding: 0.9rem 1rem; margin-bottom: 1.4rem; display: flex; align-items: flex-start; gap: 10px;">
                    <svg style="width: 20px; height: 20px; flex-shrink: 0; color: #3b82f6; margin-top: 1px;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <div style="font-size: 0.82rem; color: #1e40af; line-height: 1.5;">
                        <strong>Informasi:</strong> Fitur <strong>Order Request</strong> sekarang telah dipindahkan ke aplikasi <a href="https://apps.jnepnk.id" target="_blank" style="color: #4f46e5; font-weight: 700; text-decoration: underline;">APPSHub</a>. Silakan akses melalui APPSHub untuk membuat order request baru.
                    </div>
                </div>
