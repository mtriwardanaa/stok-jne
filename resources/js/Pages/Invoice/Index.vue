                        ...
                        <thead>
                            <tr class="bg-indigo-100 border-b border-indigo-200">
                                <th class="px-6 py-4 text-left">
                                    <span class="text-[11px] font-semibold text-indigo-800 uppercase tracking-wider">No. Invoice</span>
                                </th>
                                <th class="px-6 py-4 text-left">
                                    <span class="text-[11px] font-semibold text-indigo-800 uppercase tracking-wider">Tanggal</span>
                                </th>
                                <th class="px-6 py-4 text-left">
                                    <span class="text-[11px] font-semibold text-indigo-800 uppercase tracking-wider">No. Brg Keluar</span>
                                </th>
                                <th class="px-6 py-4 text-center">
                                    <span class="text-[11px] font-semibold text-indigo-800 uppercase tracking-wider">Items</span>
                                </th>
                                <th class="px-6 py-4 text-right">
                                    <span class="text-[11px] font-semibold text-indigo-800 uppercase tracking-wider">Total</span>
                                </th>
                                <th class="px-6 py-4 text-left">
                                    <span class="text-[11px] font-semibold text-indigo-800 uppercase tracking-wider">Dibuat</span>
                                </th>
                ...
                <div v-if="invoices.links && invoices.links.length > 3" class="px-6 py-4 border-t border-slate-100 bg-slate-50/50">
                    <div class="flex items-center justify-between">
                        <p class="text-sm text-slate-500">
                            Menampilkan {{ invoices.from }} - {{ invoices.to }} dari {{ invoices.total }} data
                        </p>
